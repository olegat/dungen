...
public class DoorDecoDialog extends DungenDialog implements ComboItemRemovedListener
{
	...
	public DoorDecoDialog(Frame owner, RandomComboBoxUpdater updater)
	{
		super(owner, "Door Decorator", "Door Decorator", updater);
		setTitle("Door Decorator");
		center.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Door Decorator", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		gridBagLayout.columnWeights = new double[]{0.0, 0.0};
		{
			...
			gbc_lblRandomi.anchor = GridBagConstraints.WEST;
		...
		}
		{
			...
			gbc_lblRandomf.anchor = GridBagConstraints.WEST;
		...
		}
		{
			...
			this.lblDensity.setToolTipText("Probabilty [0,1] of placing a prop on a door slot.");
		...
		}
		{
			...
			this.density.setToolTipText("Probabilty [0,1] of placing a prop on a door slot.");
		...
		}
		{
			...
			this.filename.setText("data/deco/door.txt");
	...
	{
		return "Door Decorator [" + filename.getText() +"]"; 
	}
