...
public class PrimDialog extends DungenDialog implements ComboItemRemovedListener
{
	protected JLabel picker;
	protected JComboBox random;
	
	public PrimDialog(Frame owner, RandomComboBoxUpdater updater)
	{
		super (owner, "Prim Digger", "Prim's algorithm", updater);
