...
public class DFSDialog extends DungenDialog implements ComboItemRemovedListener
{
	protected JLabel direction_picker;
	protected JComboBox random;
	
	public DFSDialog(Frame owner, RandomComboBoxUpdater updater)
	{
		super (owner, "DFS Digger", "Depth-first search", updater);
